                ...
                <div class="article-item">
                  <article>
                    <figure>
                      ...
                      <img src="<?php if(get_the_post_thumbnail_url( $the_query->ID, array( 500, 400) ) == true)
                      {echo get_the_post_thumbnail_url( $the_query->ID, array( 500, 400) ); } 
                      else 
                      {echo "https://place-hold.it/500x400/666/fff/000.gif"; }
                      ?>">
                      </a>
                    </figure>
      ...
      <li>
        ...
        <section class="article-widget">
          <div class="owl-carousel owl-theme owl2">
            <?php
            $query = new WP_Query('post_type=events&posts_per_page=2');
            if ($query->have_posts()) {
              while ($query->have_posts()) {
                $query->the_post();
            ?>
